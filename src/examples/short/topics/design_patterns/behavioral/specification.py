...
class CompositeSpecification(Specification):
    ...
    def and_specification(self, candidate):  # pyrefly: ignore[bad-override]
        return AndSpecification(self, candidate)

    def or_specification(self, candidate):  # pyrefly: ignore[bad-override]
        return OrSpecification(self, candidate)

    def not_specification(self):  # pyrefly: ignore[bad-override]
