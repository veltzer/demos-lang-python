...
rss = PyRSS2Gen.RSS2(
    ...
    lastBuildDate=datetime.datetime.now(),  # noqa: DTZ005
    items=[
        PyRSS2Gen.RSSItem(
            ...
            pubDate=datetime.datetime(2003, 9, 6, 21, 31)  # noqa: DTZ001
        ),
        PyRSS2Gen.RSSItem(
            ...
            pubDate=datetime.datetime(2003, 9, 6, 21, 49)  # noqa: DTZ001
        )
    ])
